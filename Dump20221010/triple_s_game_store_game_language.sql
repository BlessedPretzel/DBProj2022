...
CREATE TABLE `game_language` (
  ...
  CONSTRAINT `game_language_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game` (`game_id`),
  CONSTRAINT `game_language_ibfk_2` FOREIGN KEY (`language_id`) REFERENCES `language` (`language_id`)
