...
CREATE TABLE `orders` (
  ...
  `order_amount_paid` int NOT NULL,
  `order_payment_method` varchar(255) NOT NULL,
  `order_date_purchased` datetime NOT NULL,
  `game_id` int NOT NULL,
  `user_id` int NOT NULL,
  PRIMARY KEY (`order_id`),
  KEY `game_id` (`game_id`),
  KEY `orders_ibfk_2_idx` (`user_id`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game` (`game_id`),
...
INSERT INTO `orders` VALUES (1,1500,'VISA','2022-05-14 00:00:00',1,1);
